...
class LightColors  {
  ...
  static const Color mainColor = Color.fromRGBO(255, 190, 190, 1);
  static const Color kgrey = Color.fromRGBO(35, 110, 157, 1);
  static const Color korange = Color.fromRGBO(243, 176, 159, 1);
